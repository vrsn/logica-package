...
if "." not in __package__:
    from modules.logica.common import color, logica_lib
else:
    from ..common import color, logica_lib
...
class TestManager(object):
    ...
    @classmethod
    def RunTest(cls, name, src, predicate, golden, user_flags, import_root=None):
...
def RunTest(
    ...
    result = logica_lib.RunPredicate(
        src, predicate, user_flags=user_flags, import_root=import_root
    )
